  ...
  const renderHeader = () => (
    <header className="sticky top-0 z-30 bg-[#FFFAF5]/95 backdrop-blur-sm px-5 py-4 flex items-center justify-between border-b border-[#E5E7EB]">
      ...
      <div className="flex flex-col items-center">
        <span className="text-[10px] font-bold uppercase tracking-wider text-[#6B7280]">Proposal</span>
        <span className="font-['Space_Grotesk'] font-bold text-[#2C2C2C]">L 2024 105</span>
      </div>
    ...
    <div className="px-5 pt-6 pb-2">
      <div className="flex items-center gap-2 mb-3">
        ...
        <div className="flex items-center gap-1 text-[#FF6B35]">
          ...
          <span className="text-xs font-bold font-['Space_Grotesk']">3 days left</span>
        </div>
      </div>
  ...
  const renderAISummary = (isExpanded: boolean) => (
    <div className="mx-5 my-6 bg-[#FFFFFF] rounded-2xl p-5 shadow-[0_4px_16px_rgba(0,0,0,0.04)]">
      <div className="flex items-center gap-2 mb-3">
        ...
        <h2 className="font-['Nunito'] font-bold text-lg text-[#2C2C2C]">AI Summary</h2>
        <span className="ml-auto text-[10px] font-semibold text-[#6B7280] bg-[#F3F4F6] px-2 py-0.5 rounded-full">PLAIN LANGUAGE</span>
      </div>
      ...
      <div className="text-[#2C2C2C] leading-relaxed space-y-3">
        ...
        {isExpanded && (
          <p className="pt-2 border-t border-[#F3F4F6]">
            The government will provide a subsidy fund of 2.5 billion DKK to support the conversion. The act mandates that municipalities must report their progress annually. Failure to meet targets may result in reduced funding allocations from the national block grant.
            <br /><br />
            <strong>Key Impact:</strong> Households in rural areas may experience a temporary increase in heating bills during the transition period, estimated at 200-400 DKK annually, offset by long-term stability.
          </p>
        )}
      </div>
  ...
  const renderMediaCitations = () => (
    <div className="mb-6">
      <div className="px-5 mb-3 flex items-center justify-between">
        <h2 className="font-['Nunito'] font-bold text-lg text-[#2C2C2C]">Media Perspectives</h2>
      ...
      <div className="flex overflow-x-auto gap-4 px-5 pb-4 -mx-5 px-5">
        ...
        <div className="min-w-[280px] bg-[#FFFFFF] rounded-2xl p-5 shadow-[0_4px_16px_rgba(0,0,0,0.04)] border-l-4 border-[#22A06B]">
          <div className="flex justify-between items-start mb-2">
            ...
            <span className="text-[10px] font-bold text-[#22A06B] bg-[#22A06B]/10 px-2 py-0.5 rounded-full">SUPPORTING</span>
          </div>
          <p className="text-[#2C2C2C] text-sm font-['Nunito'] italic mb-3 relative">
            ...
            A necessary step towards Denmark's 2040 goals, though the financial burden on small municipalities requires careful monitoring.
          </p>
        ...
        <div className="min-w-[280px] bg-[#FFFFFF] rounded-2xl p-5 shadow-[0_4px_16px_rgba(0,0,0,0.04)] border-l-4 border-[#E34935]">
          <div className="flex justify-between items-start mb-2">
            <span className="text-xs font-bold text-[#6B7280]">Jyllands-Posten</span>
            <span className="text-[10px] font-bold text-[#E34935] bg-[#E34935]/10 px-2 py-0.5 rounded-full">CRITICAL</span>
          </div>
          <p className="text-[#2C2C2C] text-sm font-['Nunito'] italic mb-3 relative">
             The timeline is unrealistic for rural districts. The proposal prioritizes speed over practical feasibility.
          </p>
          <div className="flex items-center gap-1 text-[#5B4FCF] text-xs font-bold cursor-pointer hover:underline">
            Read Article <Icons.ExternalLink className="w-3 h-3" />
          </div>
    ...
    <div className="mx-5 mb-6 bg-[#FFFFFF] rounded-2xl shadow-[0_4px_16px_rgba(0,0,0,0.04)] overflow-hidden">
      <div className="p-5">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="font-['Nunito'] font-bold text-lg text-[#2C2C2C]">Who Represents Me?</h2>
        </div>

        {!isFound ? (
          <p className="text-sm text-[#6B7280] mb-4">
            Enter your postcode to see how your local representatives voted on similar issues.
          </p>
        ) : (
      ...
      {isFound && (
        <div className="bg-[#FFFAF5] p-5 border-t border-[#F3F4F6]">
          <h3 className="text-xs font-bold uppercase text-[#6B7280] mb-3 tracking-wider">Your Representatives</h3>
          <div className="flex gap-4 overflow-x-auto pb-2">
            <div className="flex flex-col items-center min-w-[80px]">
              ...
              />
              <span className="text-xs font-bold text-[#2C2C2C] text-center leading-tight">Lars Jensen</span>
              <span className="text-[10px] text-[#6B7280] text-center">Venstre</span>
            </div>
            <div className="flex flex-col items-center min-w-[80px]">
              <img 
                src="./images/mp-2.jpg" 
              ...
              />
              <span className="text-xs font-bold text-[#2C2C2C] text-center leading-tight">Sofie D.</span>
              <span className="text-[10px] text-[#6B7280] text-center">Socialdem.</span>
            </div>
             <div className="flex flex-col items-center min-w-[80px]">
              <img 
                src="./images/mp-3.jpg" 
              ...
              />
              <span className="text-xs font-bold text-[#2C2C2C] text-center leading-tight">Anders B.</span>
              <span className="text-[10px] text-[#6B7280] text-center">Radikale</span>
            </div>
          </div>
        </div>
      )}
  ...
  const renderVotingControls = () => (
    <div className="fixed bottom-0 left-0 right-0 bg-[#FFFFFF]/95 backdrop-blur-md border-t border-[#F3F4F6] p-5 z-20 rounded-t-3xl shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
      <div className="max-w-md mx-auto">
        <p className="text-center font-['Nunito'] font-bold text-[#2C2C2C] mb-4">How would you vote?</p>
    ...
    <div className="fixed bottom-0 left-0 right-0 bg-[#FFFFFF] border-t border-[#F3F4F6] p-5 z-20 rounded-t-3xl shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
      <div className="max-w-md mx-auto">
        <div className="flex items-center justify-between mb-4">
          <div>
            <p className="text-xs font-bold text-[#6B7280] uppercase tracking-wide">You voted</p>
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 rounded-full bg-[#22A06B]"></div>
              <span className="font-['Nunito'] font-bold text-[#2C2C2C] text-lg">For</span>
            </div>
          </div>
          <div className="text-right">
             <p className="text-xs font-bold text-[#6B7280] uppercase tracking-wide">Current Standings</p>
             <div className="font-['Space_Grotesk'] font-bold text-[#2C2C2C]">
               64% <span className="text-[#22A06B]">For</span> • 36% <span className="text-[#E34935]">Against</span>
             </div>
          </div>
        </div>
    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      ...
      <div className="relative bg-[#FFFFFF] w-full max-w-md rounded-t-3xl p-6 shadow-2xl animate-slide-up">
        <div className="flex justify-between items-center mb-6">
          <h2 className="font-['Nunito'] font-bold text-xl text-[#2C2C2C]">Enter Postcode</h2>
        ...
        <div className="mb-6">
          <label className="block text-sm font-bold text-[#2C2C2C] mb-2">Danish Postcode</label>
          <input 
            type="number" 
      ...
      <div className="relative bg-[#FFFFFF] w-full max-w-md rounded-t-3xl p-6 shadow-2xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="relative mb-6">
          ...
          <p className="text-[#2C2C2C] font-['Nunito'] text-lg leading-relaxed italic pl-10">
            "A necessary step towards Denmark's 2040 goals, though the financial burden on small municipalities requires careful monitoring. We cannot afford to leave the rural districts behind in this green transition."
          </p>
        </div>

        <a href="#" className="block w-full text-center bg-[#5B4FCF] text-[#FFFFFF] font-bold py-4 rounded-xl hover:bg-[#3D329F] transition-colors">
          Read Full Article
        </a>
      </div>
    </div>
  ...
  const renderShareModal = () => (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-[#FFFFFF] w-full max-w-sm rounded-3xl p-6 shadow-2xl">
        <div className="flex justify-between items-center mb-6">
          <h2 className="font-['Nunito'] font-bold text-xl text-[#2C2C2C]">Share Vote</h2>
          <button className="p-1 rounded-full bg-[#F3F4F6] text-[#6B7280]">
            <Icons.X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="grid grid-cols-4 gap-4 mb-6">
          <button className="flex flex-col items-center gap-2 group">
            ...
            <span className="text-[10px] font-bold text-[#2C2C2C]">Facebook</span>
          </button>
          <button className="flex flex-col items-center gap-2 group">
          ...
          <button className="flex flex-col items-center gap-2 group">
            ...
            <span className="text-[10px] font-bold text-[#2C2C2C]">Bluesky</span>
          </button>
          <button className="flex flex-col items-center gap-2 group">
            ...
            <span className="text-[10px] font-bold text-[#2C2C2C]">Mastodon</span>
          </button>
        </div>
